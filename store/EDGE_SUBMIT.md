...
```
https://你的GitHub用户名.github.io/bilibili-downloader/
```
...
```
B站视频下载助手帮助您在哔哩哔哩视频页面保存视频为 MP4 文件。
...
使用说明：
1. 打开 bilibili.com 任意普通视频页（/video/BV…）
...
仅在用户主动操作时于 bilibili.com 视频页本地下载并合并 MP4。
